                ...
                <Link href={item.link} key={item.link}>
                  ...
                  >
                    ...
                    {pathname === item.link && (
                      <motion.div
                        layoutId="activeTab"
                        className="absolute bg-gradient-to-r from-cyan-500 to-blue-500 rounded-full"
                      />
                    )}
                  </motion.button>
                </Link>
            ...
            <div className="flex items-center gap-4">
              ...
              >
                <div className="w-6 h-6 flex flex-col justify-center items-center">
                  ...
                  <span className="w-5 h-0.5 bg-slate-600 block mt-1 transition-all" />
                  <span className="w-5 h-0.5 bg-slate-600 block mt-1 transition-all origin-center" />
                </div>
              </button>
            </div>
          </div>
