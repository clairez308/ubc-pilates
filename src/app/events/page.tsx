...
const events = [
  ...
  },
  {
    id: 16,
    title: "Engi-YOU",
    date: "Monday, October 27, 4:45 - 6 PM",
    image: "/group/engi.jpeg",
    description: "UBC Pilates x Engi-YOU Collab!! Relaxing mini canvas painting session & Pilates class.",
    featured: false,
  },
  {
    id: 17,
    title: "Glow N' Flow",
    date: "Monday, October 20, 5-6 PM",
    image: "/group/glow.jpg",
    description: "🌙✨ Glow n Flow: Candlelight Pilates ✨🌙 Unwind with a calm, stretchy flow under soft candlelight.",
    featured: false,
  },
  {
    id: 18,
    title: "Wednesday Adamms Theme Class",
    date: "Wednesday, October 29, 5-6 PM",
    image: "/group/wednesday.jpg",
    description: "🕸️ Something spooky is coming to the mat… 🦇Join us for a special Wednesday Addams–inspired Pilates class!💀",
    featured: false,
  },
  {
    id: 19,
  ...
  },
  {
    ...
    description: "☕ Our first Execs & Members Social — a cozy fall evening to relax, mingle, and have some fun after class! 🍂",
    featured: false,
  },
